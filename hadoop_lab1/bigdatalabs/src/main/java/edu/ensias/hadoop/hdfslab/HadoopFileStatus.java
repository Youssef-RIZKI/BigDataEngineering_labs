...
public class HadoopFileStatus {
    public static void main(String[] args) {
        ...
        try {
            ...
            String chemin_fichier = args[0];// "/user/root/input";
            String nom_fichier = args[1];// "purchases.txt";
            Path filepath = new Path(chemin_fichier, nom_fichier);
            ...
            fs.rename(filepath, new Path("/user/root/input", args[2])); //arg[2] = "Achats.txt"
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
